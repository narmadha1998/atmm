 ...
 */
define('MATHCAPTCHA_MAX_QUESTION_NUMBER_SIZE',      50);
 ...
 */
define('MATHCAPTCHA_NUM_ADDITION_PHRASES',          25);
    ...
    public function get_question()
    {
        ...
        switch($this->operation)
        {
            case 'addition' :
                ...
                $phrase = 'mathcaptcha_addition_2_1';
            break;
        ...
        {       
            ...
            $Qp=$this->compile_question($phrase, array($number2, $number1));
            return array("question"=>$Qp,"number1"=>$number1,"number2"=>$number2);
        }
        else
        {
            //Return the CAPTCHA question
            $Qp=$this->compile_question($phrase, array($number1, $number2));
            return array("question"=>$Qp,"number1"=>$number1,"number2"=>$number2);
        }
    }
